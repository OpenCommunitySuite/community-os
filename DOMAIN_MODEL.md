...
Документ опирается на нормативные `TERMINOLOGY.md` и ADR-001. Он охватывает сообщество, субъектов, объекты, финансы, ресурсы, инженерную инфраструктуру, документы, управление, собрания и голосования.
...
**Лицевой счёт** — финансовый контекст учёта начислений, платежей, задолженности, переплаты и других операций, связанных с объектом собственности или группой объектов. Он не тождествен субъекту, собственнику или пользователю.

**Начисление** — операция определения суммы, предъявляемой на основании правила. Оно может основываться на площади, фиксированной сумме, потреблении, тарифе, взносе, распределённых потерях, пене или иной формуле.

**Финансовое обязательство** — требование уплаты суммы сообществу, возникшее из начисления или иного основания. Для конкретного обязательства определяются его основание, относящийся лицевой счёт, должник, срок оплаты и состояние. Плательщик платежа может не совпадать с должником.

**Платёж** — факт поступления денежных средств сообществу. Он имеет плательщика, сумму, дату, способ и назначение. Один платёж может погашать несколько обязательств, одно обязательство — несколькими платежами. Наличный и безналичный платежи имеют общий финансовый результат, но могут иметь различное документальное оформление.

**Задолженность** — непогашенная часть финансовых обязательств. **Переплата** — остаток поступивших средств, превышающий погашенные обязательства в применимом финансовом контексте. **Пеня** — отдельное начисление за просроченное обязательство по применимому правилу.

**Тариф** определяет стоимость единицы ресурса, услуги или другой позиции начисления и действует в определённом периоде. **Статья начисления** классифицирует назначение начисления и не обязана совпадать со статьёй бухгалтерского учёта.

## 11. Ресурсы, приборы и инженерная структура

**Ресурс** — физический ресурс, потребление которого измеряется или рассчитывается: электроэнергия, вода, газ, тепло или иной поддерживаемый ресурс.

**Инженерная система** — совокупность связанных технических элементов для производства, передачи, распределения, измерения или использования ресурса. Она независима от иерархии объектов собственности и может обслуживать один объект, группу объектов, сообщество или не быть прямо связанной с объектом.

**Точка подключения** связывает объект или иного потребителя с инженерной системой. **Инженерная ветвь** описывает участок распределения ресурса. **Ветвь учёта ресурса** описывает самостоятельную цепочку учёта конкретного ресурса; она может использовать элементы инженерной системы, но не тождественна ей.

**Прибор учёта** измеряет ресурс, может быть связан с одним или несколькими объектами, принадлежать сообществу и участвовать в ветвях учёта в разные периоды. Общий, промежуточный, индивидуальный и контрольный приборы описывают назначение или положение прибора. Уличный счётчик — частный случай промежуточного прибора в профиле СНТ.

**Показание** — зафиксированное значение прибора на определённый момент. Для него различаются способ получения, источник, действие фиксации и зафиксировавший субъект или автоматическое происхождение, если они применимы. История показаний сохраняется.

**Потребление** определяется по показаниям, нормативу, расчёту или иному правилу. Индивидуальное потребление относится к объекту или группе объектов; потребление сообщества относится к инфраструктуре или общим нуждам. Потребление не определяет автоматически финансирование или начисление.

**Расчётный небаланс** — аналитическая разница между связанными уровнями учёта. **Эксплуатационная потеря** — фактическая потеря из-за эксплуатации или неисправности. Небаланс не равен автоматически эксплуатации, задолженности или неучтённому потреблению.

Распределение выявленного небаланса — настраиваемая функция сообщества. Оно не изменяет исходные показания, фактическое потребление или историю измерений; при применении может стать основанием отдельного начисления.

## 12. Поставщики, расходы и смета

**Поставщик** предоставляет сообществу ресурс, услугу или иное обеспечение. **Договор с поставщиком** определяет условия получения, учёта объёмов и взаиморасчётов.

**Обязательство перед поставщиком** возникает из счёта, акта, данных приборов, договора или другого основания. **Платёж поставщику** погашает одно или несколько таких обязательств. Расчёты с поставщиком включают регистрацию обязательств, документов, платежей, сверку и контроль задолженности.

**Расход сообщества** — затрата для деятельности сообщества, общего имущества, ресурсов или услуг. Он не является автоматически индивидуальным начислением собственнику.

**Смета** — утверждённый план доходов и расходов на период. Она не заменяет фактический финансовый учёт. **Источник финансирования** — вид поступлений, за счёт которого планируется или фактически покрывается расход. **Финансирование расхода** связывает расход и источники; оно не тождественно начислению собственнику.
...
- показание ≠ потребление; потребление ≠ начисление; начисление ≠ платёж.
