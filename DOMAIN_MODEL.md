...
Документ опирается на нормативные `TERMINOLOGY.md` и ADR-001–ADR-011. Он охватывает сообщество, субъектов, идентичность и доступ, объекты, финансы, ресурсы, инженерную инфраструктуру, документы, коммуникации, управление, собрания, голосования и интеграционные границы.
