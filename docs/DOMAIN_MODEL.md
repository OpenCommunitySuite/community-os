...
**Access Grant** — исторически объяснимое предоставление определённых прав доступа пользовательской учётной записи в определённой области применимости согласно допустимому основанию и применимым правилам. Access Grant не является собственностью, членством, представительством, предметным полномочием или правом голоса и не создаёт их.
