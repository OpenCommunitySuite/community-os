...
**Предоставление доступа (Access Grant)** — исторически объяснимое предоставление определённых прав доступа пользовательской учётной записи в определённой области применимости согласно допустимому основанию и применимым правилам.

Access Grant не является собственностью, членством, представительством, предметным полномочием или правом голоса и не создаёт их. Один пользователь может иметь несколько независимых grants на разных основаниях и в разных областях применимости.
