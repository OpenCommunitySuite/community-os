...
Supplier сохраняется как полезный нормативный термин, но его следует уточнить как **контекстную предметную роль Subject**, а не отдельный тип или identity Subject.

Не каждый внешний Subject является Supplier.

Contractor, Lessor, Lessee, Bank, Payer и Recipient не сводятся автоматически к Supplier.
