...
ГПХ с внешним исполнителем, поставка ресурса, банковское обслуживание или использование инфраструктуры могут образовывать Contractual Relationship, если устойчивое отношение Community↔Subject само имеет необходимую предметную identity и последствия.
