...
**Статус:** Frozen / Round 1 / Corrected package v2  
**Review Package ID:** STAGE9-TRANS-001-R1-V2  
...
> Это единственный package, который следует использовать для Round 1. Предыдущий файл `STAGE-9-FINANCIAL-DISCLOSURE-REVIEW-PACKAGE.md` не использовать: при автоматической сборке в нём отсутствовали часть excerpt ADR-006, ADR-009 и ADR-004. Внешним рецензентам тот package не передавался.
