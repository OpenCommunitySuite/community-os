...
**Статус:** Frozen / Round 1  
**Review Package ID:** STAGE9-TRANS-001-R1  
**Base:** `main@87e59549fcceb465540d583def7c0636d265d3e3`  
**Branch:** `docs/bp-trans-001-financial-disclosure`  
**Draft BP SHA:** `6d302e86021859d55b3564edb8adb53a474974a6`  
**Frozen package source commit:** to be the commit creating this file  
**Тип review:** предметно-архитектурный, без проектирования кода/БД/API/UI

> Этот package является замороженным входом Round 1. После создания содержательно не изменяется. Если Draft BP меняется по результатам review, это не изменяет package; второй раунд создаётся только при существенном нерешённом разногласии.
...
6. Корректно ли различены:
   - current effective financial state;
   - historical reconstruction;
   - content actually published historically?
...
## 12. Source G — ADR-004 historical semantics excerpt
...
## 13. Draft under review — BP-TRANS-001
