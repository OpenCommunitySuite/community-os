...
8. кассир фиксирует сумму, фактически принятую Community; иные наличные, не вошедшие в Community-side control, в Community OS не отражаются;
9. принятая Community сумма образует Cash Acceptance и при достаточном основании — recognized Cash Payment(s);
10. `BP-FIN-ALLOCATION-001` фиксирует фактическое распределение Payment по обязательствам/допустимому финансовому смыслу;
11. если принятая сумма выше оплачиваемых текущих обязательств, остаток не становится Advance автоматически: владелец/применимое правило должны установить допустимое назначение, например будущая электроэнергия, вода или членские взносы;
...
### 34.1. Принятая сумма выше текущих обязательств, остаток получает финансовый смысл

Если после расчёта текущие обязательства составляют 980,67 грн, а Community принимает 1000 грн по явному указанию владельца оставить 19,33 грн для будущей электроэнергии:
...
Это не округление задолженности до 1000. Community фактически приняло 1000 грн, а financial context отдельно определил смысл доступной части Payment согласно `BP-FIN-ALLOCATION-001`.

Само превышение принятой суммы над текущими обязательствами не создаёт Advance.
...
Community принимает сумму, равную выбранным обязательствам.
...
### 35.27. Сумма скорректирована до подтверждения

До завершения Cash Acceptance кассир уточняет фактически принимаемую сумму. Community OS фиксирует только итоговую принятую сумму; иные наличные не становятся частью операции и не создают Refund/outgoing Payment.

### 35.28. Принятая сумма выше текущей задолженности: остаток признан Advance

Владелец явно указывает допустимое назначение остатка принятой суммы, например будущая электроэнергия.
