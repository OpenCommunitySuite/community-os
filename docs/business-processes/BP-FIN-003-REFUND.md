...
- решение уполномоченного органа/лица в пределах применимой предметной политики, если оно устанавливает возврат средств с прослеживаемым refund origin;
- иное допустимое финансовое основание, сохраняющее возвратную природу операции.

Наличие первоначального Payment само по себе не означает наличие права на Refund. Аналогично, само по себе решение выплатить средства без refund origin не превращает выплату в Refund.
...
- принято и допустимо отдельное решение о возврате, имеющее прослеживаемый refund origin, без отмены исходного obligation;
- иное предметно допустимое возвратное основание.
