...
1. **BP-FIN-ALLOCATION-001 — первичное распределение признанного платежа** — зафиксирован как рабочая предметная основа; channel-independent Initial Allocation отделён от Payment recognition и Reallocation;
2. **BP-FIN-002 — исправление ошибочного признания платежа**;
3. **BP-FIN-003 — возврат платежа**;
