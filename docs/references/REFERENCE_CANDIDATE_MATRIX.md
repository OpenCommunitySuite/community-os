...
| REF-DOC-004 | Формирование и выдача кассового документа / квитанции | пилотный СТ, BP-CASH-001, BP-CASH-002 | ADR-009 уже определяет Document/Revision/Representation/Signing/Registration; cash BP отделяют документ от Cash Acceptance/Cash Disbursement/Payment; требуется прикладная document-kind semantics печати, повторной выдачи и исправления | **Следующий** | `BP-DOC-CASH-001`: определить формирование кассового документа, printable/PDF Representation, reprint, нумерацию/подписание по policy и историческую связь с cash/Payment facts без превращения документа в финансовую истину |
| REF-DOC-005 | Правовые и фискальные требования к кассовому документу украинского пилота | пилотный СТ | Архитектурная модель документа отделена от финансовых фактов, но ещё не проверено, когда для конкретных операций обязательны специальная форма, ПКО/РКО, фискальный чек, РРО/ПРРО, подписи/регистрация и какие требования предъявляются к бумажному/электронному экземпляру | **Следующий** | После принятия BP-DOC-CASH-001 провести отдельный актуальный legal/formalization analysis для Украины; не считать печатную квитанцию Community OS автоматически фискальным/регламентированным документом |
