...
**Актуально относительно:** нормативной модели после `BP-FIN-005 — Отмена, исправление и перерасчёт начисления`; DOMAIN_MODEL 0.14, TERMINOLOGY 0.12  
...
6. **BP-CASH-001 — приём наличного платежа без смешения платежа, кассового действия и кассового документа** — следующий процесс;
