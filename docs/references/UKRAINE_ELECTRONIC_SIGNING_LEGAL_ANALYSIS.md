...
## 8. Кооперативы и садовые товарищества: ограничение текущего анализа

Закон Украины «Про кооперацію» регулирует общие собрания кооператива, однако текущий анализ **не подтверждает универсальное правило**, что любое садовое товарищество в Украине является кооперативом или что для любого СТ закон уже задаёт такую же электронную процедуру, как для ОСББ.

Старые отраслевые материалы также показывают, что исторически садовые товарищества могли существовать в разных организационно-правовых формах и значительно опираться на собственный статут.

**Поэтому для первого пилота СТ нельзя зашивать ОСББ-процедуру как universal rule.**

До включения юридически значимого remote voting для пилотного СТ необходимо установить:

1. текущую организационно-правовую форму конкретного СТ;
2. применимый закон;
3. действующий статут;
4. как статут определяет собрание, уведомление, кворум, представительство, форму голосования и оформление результатов;
5. допускается ли electronic/remote form и какой тип подписи требуется.

Это отдельный profile/legal input, а не основание менять universal Governance model.
